...
**95 automation tests pass, 0 failures, headless.** The correspondence engine — the
...
**Verify (headless):**
```powershell
Tools\CI\run_tests.ps1      # build editor target + all MANIFOLD tests (expect 95 Success, 0 Fail)
