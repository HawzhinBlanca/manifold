...
[![Tests](https://img.shields.io/badge/automation%20tests-78%2F78%20green-brightgreen)]()
...
- ✅ **78 / 78** automation tests pass, headless, 0 failures
...
Expected: `78 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
