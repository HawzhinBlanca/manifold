...
[![Tests](https://img.shields.io/badge/automation%20tests-93%2F93%20green-brightgreen)]()
...
- ✅ **93 / 93** automation tests pass, headless, 0 failures
...
Expected: `93 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
