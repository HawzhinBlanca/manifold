...
[![Tests](https://img.shields.io/badge/automation%20tests-82%2F82%20green-brightgreen)]()
...
- ✅ **82 / 82** automation tests pass, headless, 0 failures
...
Expected: `82 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
