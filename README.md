...
[![Tests](https://img.shields.io/badge/automation%20tests-91%2F91%20green-brightgreen)]()
...
- ✅ **91 / 91** automation tests pass, headless, 0 failures
...
Expected: `91 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
