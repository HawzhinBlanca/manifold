...
[![Tests](https://img.shields.io/badge/automation%20tests-84%2F84%20green-brightgreen)]()
...
- ✅ **84 / 84** automation tests pass, headless, 0 failures
...
Expected: `84 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
