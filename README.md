...
[![Tests](https://img.shields.io/badge/automation%20tests-76%2F76%20green-brightgreen)]()
...
- ✅ **76 / 76** automation tests pass, headless, 0 failures
...
Expected: `76 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
