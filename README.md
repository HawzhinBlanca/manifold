...
[![Tests](https://img.shields.io/badge/automation%20tests-104%2F104%20green-brightgreen)]()
...
- ✅ **104 / 104** automation tests pass, headless, 0 failures
...
Expected: `104 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
...
- [`Docs/LOOP_PROMPT.md`](Docs/LOOP_PROMPT.md) — the continuous-improvement `/loop` prompt (elite-studio quality bar)
