...
[![Tests](https://img.shields.io/badge/automation%20tests-97%2F97%20green-brightgreen)]()
...
- ✅ **97 / 97** automation tests pass, headless, 0 failures
...
Expected: `97 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
