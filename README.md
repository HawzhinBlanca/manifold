...
[![Tests](https://img.shields.io/badge/automation%20tests-74%2F74%20green-brightgreen)]()
...
- ✅ **74 / 74** automation tests pass, headless, 0 failures
...
Expected: `74 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
