...
[![Tests](https://img.shields.io/badge/automation%20tests-99%2F99%20green-brightgreen)]()
...
- ✅ **99 / 99** automation tests pass, headless, 0 failures
...
Expected: `99 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
