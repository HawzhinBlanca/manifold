...
[![Tests](https://img.shields.io/badge/automation%20tests-71%2F71%20green-brightgreen)]()
...
- ✅ **71 / 71** automation tests pass, headless, 0 failures
...
Expected: `71 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
