...
[![Tests](https://img.shields.io/badge/automation%20tests-79%2F79%20green-brightgreen)]()
...
- ✅ **79 / 79** automation tests pass, headless, 0 failures
...
Expected: `79 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
