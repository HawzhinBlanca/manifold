...
[![Tests](https://img.shields.io/badge/automation%20tests-77%2F77%20green-brightgreen)]()
...
- ✅ **77 / 77** automation tests pass, headless, 0 failures
...
Expected: `77 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
