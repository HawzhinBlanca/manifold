...
[![Tests](https://img.shields.io/badge/automation%20tests-75%2F75%20green-brightgreen)]()
...
- ✅ **75 / 75** automation tests pass, headless, 0 failures
...
Expected: `75 Success, 0 Fail`. Close the Unreal Editor first (Live Coding holds a
